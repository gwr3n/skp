...
public class SKPMultinormalSAASolvedInstance {
   ...
   public SKPMultinormalSAASolvedInstance(SKPMultinormal instance, int[] optimalKnapsack, double simulatedSolutionValue, double solutionTimeMs, double optGap1, double optGap2, int Nsmall, int Nlarge, int M) {
