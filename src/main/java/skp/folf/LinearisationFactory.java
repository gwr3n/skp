...
public class LinearisationFactory {
   ...
   /**
    * Choose suitable linearisation parameters (number of segments W for
    * the first-order loss function approximation, and number of segments Q
    * for the square-root function approximation) such that the overall
    * linearisation error is at most epsilon.
    * 
    * @param epsilon
    * @param Vmax
    * @param c
