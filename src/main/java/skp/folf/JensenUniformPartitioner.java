...
/**
 * Jensen uniform partitioner for standard normal distribution.
 * <p>
 * This class implements a uniform-probability partitioning scheme
 * for the standard normal distribution, designed to minimize the
 * Jensen lower bound on the moment-generating function approximation error.
 * The partition divides the distribution into segments of equal probability,
 * and computes the conditional means within each segment using numerically
 * stable methods.
 * <p>
 * The implementation includes various numerical techniques to ensure
 * stability when dealing with extreme tails of the normal distribution,
 * such as using log-density calculations and stable difference methods.
 * <p>
 * Example usage:
 * <pre>
 *    JensenUniformPartitioner partitioner = new JensenUniformPartitioner();
 *    Result result = partitioner.compute(10); // 10 segments
 * </pre>
 */
