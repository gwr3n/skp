...
public class SKPGenericDistributionScenarioBased {
   ...
   public SKPGenericDistributionScenarioBased(SKPGenericDistribution instance, int numberOfScenarios, RandomStream randGenerator) {
   ...
   public SKPGenericDistributionScenarioBased(SKPGenericDistribution instance, int numberOfScenarios) {
   ...
   public SKPGenericDistributionScenarioBasedSolvedInstance solve(int simulationRuns) throws IloException {
   ...
   public static void main(String args[]) {
      ...
      try {
         ...
         SKPGenericDistributionScenarioBased sskp = new SKPGenericDistributionScenarioBased(instance, numberOfScenarios);
