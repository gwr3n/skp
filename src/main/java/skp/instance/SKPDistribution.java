...
public class SKPDistribution extends SKP{
   
   Distribution[] weights;
   double capacity;
   
   public SKPDistribution(double[] expectedValuesPerUnit, Distribution[] weights, double capacity, double shortageCost) {
   ...
   public boolean equals(Object obj) {
      if(obj instanceof SKPDistribution) {
         SKPDistribution o = (SKPDistribution) obj;
   ...
   public static SKPDistribution getTestInstance() {
      ...
      return new SKPDistribution(expectedValuesPerUnit, expectedWeights, capacity, shortageCost);
   }
}
