...
public class DSKPGenericDistribution extends DSKP{
   ...
   public DSKPGenericDistribution(SKPGenericDistribution instance, double truncationQuantile) {
   ...
   public DSKPGenericDistributionSolvedInstance solve() {
      /**
      ...
      return new DSKPGenericDistributionSolvedInstance(instance, solutionValue, solutionTimeMs, statesExplored);
   }
   ...
   public static void main(String args[]) {
      ...
      DSKPGenericDistribution dskp = new DSKPGenericDistribution(instance, truncationQuantile);
      
      System.out.println(GSONUtility.<DSKPGenericDistributionSolvedInstance>printInstanceAsJSON(dskp.solve()));
   }
}
