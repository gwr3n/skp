...
This is a Numba implementation of the original code in branch_and_bound.py 
...
def continuous_knapsack_solver(r, mu, v, C, p, fixed=None, tol=1e-5):
    ...
    # -----------------------------------------------------------------------------------
    # Explicitly add the candidate corresponding to "all free items = 1" 
    ...
    # Explicitly add the candidate corresponding to "all free items = 0"
